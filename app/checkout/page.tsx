...
function CheckoutContent() {
    ...
    return (
        <>
            <Navbar />
            <section className="bg-[#FFFDD0] pt-8 pb-12 md:pt-12 md:pb-16 text-neutral-900">
            ...
            <section className="bg-[#FFFDD0] pb-24 md:pb-32 min-h-[70vh]">
    ...
    {/* Deposit Policy Card */}
    <div className="bg-[#FFFDD0] rounded-2xl p-6 md:p-8 border border-neutral-200/70 shadow-[0_10px_35px_rgba(0,0,0,0.06)]">
