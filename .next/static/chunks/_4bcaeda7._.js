...
;
function Footer() {
    let { videoSrc = '/Footer/IMG_2004.mov' } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
function GalleryPage() {
    let { editMode = false, onEdit = null, onDelete = null, onToggleFeatured = null, selectedItems = [], onToggleSelection = null } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    _s();
    ...
    const [cardImageIndexes, setCardImageIndexes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GalleryPage.useEffect": ()=>{
            const fetchGalleryData = {
                "GalleryPage.useEffect.fetchGalleryData": async ()=>{
                    try {
                        setLoading(true);
                        const [imagesRes, categoriesRes] = await Promise.all([
                            fetch("".concat(API_BASE_URL, "/api/gallery")),
                            fetch("".concat(API_BASE_URL, "/api/categories"))
                        ]);
            ...
            }["GalleryPage.useEffect.fetchGalleryData"];
            fetchGalleryData();
        }
    }["GalleryPage.useEffect"], []);
    const filterOptions = [
    ...
    const galleryCategories = categories.map((cat)=>{
        ...
        const subcategoryData = (cat.subcategories || []).map((sub)=>{
            ...
            const imageArray = sub.images && sub.images.length > 0 ? sub.images : subImages.length > 0 ? subImages.map((img)=>img.imageUrl) : sub.image ? [
                sub.image
            ] : [];
            return {
                id: sub.id,
        ...
        const flippingImages = cat.flippingImages && cat.flippingImages.length > 0 ? cat.flippingImages : categoryImages.slice(0, 5).map((img)=>img.imageUrl);
        ...
        return {
            ...
            images: flippingImages.length > 0 ? flippingImages : firstImage ? [
                firstImage.imageUrl
            ] : [],
            link: "/".concat(cat.slug),
            tags: [
                cat.name,
                'Protective Styles'
            ],
    ...
    const fallbackGalleryCategories = [
            ...
            subcategoryData: [
                {
                    ...
                    slug: '2-strands-twists',
                    image: '/Gallery/Twists/2-strands-twists/IMG_9101.jpg',
                    images: [
                ...
                },
                {
                    ...
                    slug: 'bohemian-marley-twists',
                    image: '/Gallery/Twists/Bohemian-marley twists/IMG_9054.jpg',
                    images: [
                        '/Gallery/Twists/Bohemian-marley twists/IMG_9054.jpg'
                    ]
                },
                {
                    name: 'Havana Marley Twists',
                    slug: 'havana-marley-twists',
                    image: '/Gallery/Twists/Havana-marley-twists/IMG_9048.jpg',
                    images: [
                        '/Gallery/Twists/Havana-marley-twists/IMG_9048.jpg'
                    ]
                },
                {
                    name: 'Islands Twists',
                    slug: 'islands-twists',
                    image: '/Gallery/Twists/Islands-Twists/IMG_9052.jpg',
                    images: [
                        '/Gallery/Twists/Islands-Twists/IMG_9052.jpg'
                    ]
                },
                {
                    name: 'Kinky Twists',
                    slug: 'kinky-twists',
                    image: '/Gallery/Twists/kinky-twists/IMG_1602.JPG',
                    images: [
                        '/Gallery/Twists/kinky-twists/IMG_1602.JPG'
                    ]
                },
                {
                    name: 'Passion Twists',
                    slug: 'passion-twists',
                    image: '/Gallery/Twists/passion-twists/IMG_9049.jpg',
                    images: [
                ...
                },
                {
                    name: 'Spring Twists',
                    slug: 'spring-twists',
                    image: '/Gallery/Twists/spring-twists/IMG_9123.jpg',
                    images: [
        ...
        },
        {
            ...
            subcategoryData: [
                ...
                },
                {
                    ...
                    images: [
                        '/Gallery/Box-Braids /French curls/IMG_7654.JPEG'
                    ]
                },
                {
                    name: 'Bohemian',
        ...
        },
        {
            ...
            subcategoryData: [
                ...
                },
                {
                    ...
                    images: [
                        '/Gallery/Crochets/Loose hair/IMG_9366.jpg'
                    ]
                },
                {
                    name: 'Pre-Twisted',
                    ...
                    images: [
                        '/Gallery/Crochets/pre-twisted/IMG_9375.jpg'
                    ]
                },
                {
        ...
        },
        {
            ...
            images: [
                '/Gallery/Men/2-stranded-twist/IMG_0133.JPG',
                '/Gallery/Men/Conrows/IMG_9419.jpg'
            ],
            subcategoryData: [
                {
                    name: '2-Stranded Twist',
                    slug: '2-stranded-twist',
                    image: '/Gallery/Men/2-stranded-twist/IMG_0133.JPG',
                    images: [
                        '/Gallery/Men/2-stranded-twist/IMG_0133.JPG',
                        '/Gallery/Men/2-stranded-twist/IMG_9450.jpg'
                    ]
                },
                {
                    name: 'Conrows',
                    slug: 'conrows',
                    image: '/Gallery/Men/Conrows/IMG_9419.jpg',
                    images: [
                        '/Gallery/Men/Conrows/IMG_9419.jpg',
                        '/Gallery/Men/Conrows/IMG_9444.jpg',
                        '/Gallery/Men/Conrows/IMG_9445.jpg',
                        '/Gallery/Men/Conrows/IMG_9446.jpg',
                        '/Gallery/Men/Conrows/IMG_9447.jpg'
                    ]
                }
            ]
        }
    ...
    const getDisplayItems = ()=>{
        ...
        if (selectedSubcategories.length > 0) {
            return selectedSubcategories.map((subcategoryId)=>{
                ...
                return {
                    ...
                    link: subcategoryId,
                    bookingLink: "/booking/".concat(categorySlug, "/").concat(subcategorySlug),
                    description: "".concat(category.title, " - ").concat(subcategory.name),
                    tags: category.tags
                };
            }).filter(Boolean);
        }
        ...
        if (!searchQuery) {
            return galleryCategories.filter(matchesFilter).map((cat)=>({
                    type: 'category',
                    ...cat,
        ...
        galleryCategories.forEach((category)=>{
            ...
            const matchesTitle = category.title.toLowerCase().includes(searchLower) || category.description && category.description.toLowerCase().includes(searchLower);
            if (matchesTitle) {
                items.push({
                    type: 'category',
                    ...category
            ...
            const matchingSubcategories = category.subcategoryData.filter((sub)=>sub.name.toLowerCase().includes(searchLower));
            ...
            matchingSubcategories.forEach((sub)=>{
                ...
                items.push({
                    ...
                    link: "".concat(category.link, "?style=").concat(sub.slug),
                    bookingLink: "/booking/".concat(categorySlug, "/").concat(sub.slug),
                    description: "".concat(category.title, " - ").concat(sub.name),
                    tags: category.tags
                });
            });
        });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GalleryPage.useEffect": ()=>{
                            ...
                            if (item.type === 'category' && item.images && item.images.length > 1) {
                                ...
                                setTimeout({
                                    "GalleryPage.useEffect.interval": ()=>{
                                        ...
                                        }["GalleryPage.useEffect.interval"], 300);
                                    }
                                }["GalleryPage.useEffect.interval"], 300);
                            }
                        }
            ...
            }["GalleryPage.useEffect.interval"], 3000);
            return ({
    ...
    const toggleSubcategory = (categoryLink, subcategorySlug)=>{
        const subcategoryId = "".concat(categoryLink, "?style=").concat(subcategorySlug);
    ...
    const openModal = function(item) {
        let imageIndex = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "container mx-auto px-6 md:px-8 lg:px-12 py-8",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                className: "text-base font-semibold text-[#2C1810] mb-5 uppercase tracking-[0.15em] pb-3 border-b border-neutral-100",
                                                children: "Filters"
                                            }, void 0, false, {
                                                fileName: "[project]/app/gallery/page.jsx",
                                                lineNumber: 376,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "w-full text-left px-4 py-2.5 text-xs uppercase tracking-[0.12em] transition-all rounded-lg ".concat(selectedFilter === 'All' ? 'bg-[#2C1810] text-white font-semibold shadow-sm' : 'bg-transparent text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900'),
                                                        children: "All"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/gallery/page.jsx",
                                                        lineNumber: 383,
                                                    ...
                                                    galleryCategories.map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "space-y-1",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                            ...
                                                                            className: "flex-1 text-left px-4 py-2.5 text-xs uppercase tracking-[0.12em] transition-all rounded-lg ".concat(selectedFilter === category.title ? 'bg-[#2C1810] text-white font-semibold shadow-sm' : 'bg-transparent text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900'),
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                            ...
                                                                            children: expandedCategories[category.title] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$minus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Minus$3e$__["Minus"], {
                                                                                size: 14
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/gallery/page.jsx",
                                                                                lineNumber: 417,
                                                                ...
                                                                expandedCategories[category.title] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "ml-4 space-y-1 mt-1",
                                                                    children: category.subcategoryData.map((sub)=>{
                                                                        const subcategoryId = "".concat(category.link, "?style=").concat(sub.slug);
                                                                        ...
                                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    className: "uppercase tracking-wider group-hover:text-neutral-900",
                                                                                    children: sub.name
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/app/gallery/page.jsx",
                                                                                    lineNumber: 442,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "w-full text-left px-4 py-2.5 text-xs uppercase tracking-[0.12em] transition-all rounded-lg ".concat(selectedFilter === 'Protective Styles' ? 'bg-[#2C1810] text-white font-semibold shadow-sm' : 'bg-transparent text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900'),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-[10px] text-neutral-500 uppercase tracking-[0.15em] font-medium",
                                                    children: [
                                                        displayItems.length,
                                                        " ",
                                                        displayItems.length === 1 ? 'Style' : 'Styles',
                                                        " Found"
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/app/gallery/page.jsx",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: displayItems.map((item, index)=>{
                                                ...
                                                const currentImage = item.images && item.images.length > 0 ? item.images[cardImageIndex] : item.image;
                                                const itemId = item.link || "item-".concat(index);
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        editMode && onToggleSelection && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        editMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                onEdit && !isSubcategory && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: (e)=>{
                                                                        e.stopPropagation();
                                                                        onEdit(item);
                                                                    },
                                                                    className: "p-2 bg-white rounded-full shadow-lg hover:bg-neutral-100 transition-colors",
                                                                    title: "Edit ".concat(item.title),
                                                                    "aria-label": "Edit ".concat(item.title),
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "border-2 border-black p-4 mb-3 hover:border-neutral-600 transition-colors relative overflow-hidden ".concat(isSelected ? 'ring-4 ring-blue-500' : ''),
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: currentImage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                            src: currentImage,
                                                                            alt: item.title,
                                                                            ...
                                                                            className: "w-full h-full bg-neutral-300 flex items-center justify-center",
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            className: "text-white text-sm uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-semibold",
                                                                            children: isSubcategory ? 'Click to View' : 'View Gallery'
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/gallery/page.jsx",
                                                                            lineNumber: 609,
                                                                            columnNumber: 29
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                                    className: "uppercase tracking-[0.25em] text-neutral-900 font-semibold mb-3 ".concat(isSubcategory ? 'text-[11px] md:text-[13px] underline decoration-1 underline-offset-4 hover:decoration-2 transition-all' : 'text-[13px] md:text-[15px] mb-2'),
                                                                    children: item.title
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/gallery/page.jsx",
                                                                    lineNumber: 618,
                                                                ...
                                                                !isSubcategory && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    ...
                                                                    children: isSubcategory ? 'Book Now' : 'Explore'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/gallery/page.jsx",
                                                                    lineNumber: 632,
                                                                    columnNumber: 25
                    ...
                    isModalOpen && selectedCategory && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-neutral-900/50 rounded-xl max-w-md w-full",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center justify-center py-6 border-b border-white/10",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            className: "text-base md:text-lg font-normal text-white",
                                            children: selectedCategory.title
                                        }, void 0, false, {
                                            fileName: "[project]/app/gallery/page.jsx",
                                            lineNumber: 671,
                                            columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-4",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "relative w-full aspect-[3/4] bg-black rounded-lg overflow-hidden",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                    src: selectedCategory.images[currentImageIndex],
                                                    alt: "".concat(selectedCategory.title, " ").concat(currentImageIndex + 1),
                                                    className: "w-full h-full object-cover"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/gallery/page.jsx",
                                                    lineNumber: 680,
                                                ...
                                                selectedCategory.images.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "pb-4 px-4",
                                        children: [
                                            selectedCategory.images.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex gap-2 justify-center mb-4 overflow-x-auto pb-2",
                                                children: selectedCategory.images.map((image, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>setCurrentImageIndex(index),
                                                        className: "flex-shrink-0 w-14 h-16 rounded overflow-hidden ".concat(index === currentImageIndex ? 'ring-2 ring-white' : 'opacity-60 hover:opacity-100'),
                                            ...
                                            selectedCategory.images.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: selectedCategory.images.map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "h-1.5 rounded-full transition-all ".concat(index === currentImageIndex ? 'w-6 bg-white' : 'w-1.5 bg-gray-600')
                                                    }, index, false, {
                                                        fileName: "[project]/app/gallery/page.jsx",
                                                        lineNumber: 737,
                                                        columnNumber: 21
...
_s(GalleryPage, "WX/3CSXmN96F1MuVjprZ45y3PFU=", false, function() {
    return [
...
//# sourceMappingURL=_4bcaeda7._.js.map