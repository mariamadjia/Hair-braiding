...
export default async function Services() {
  ...
  try {
    ...
    return (
      <section className="relative overflow-hidden bg-[#C6B6A4] pt-24 pb-12 text-neutral-900 dark:bg-neutral-900 dark:text-white md:pt-32 md:pb-16">
  ...
  return (
    <>
      <section
        id="services"
        className="relative overflow-hidden bg-[#C6B6A4] pt-24 pb-12 text-neutral-900 dark:bg-neutral-900 dark:text-white md:pt-32 md:pb-16"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center md:mb-14">
            <p className="mb-4 text-xs uppercase tracking-[0.4em] text-neutral-500 dark:text-neutral-400">
      ...
      <section className="bg-[#C6B6A4] pb-24 dark:bg-neutral-900 md:pb-32">
