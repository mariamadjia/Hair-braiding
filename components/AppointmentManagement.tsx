                                ...
                                <div className="grid gap-5 pl-2 lg:grid-cols-[minmax(230px,0.85fr)_minmax(300px,1.2fr)_auto] lg:items-center">
                                    ...
                                    <div className="relative flex shrink-0 items-center justify-end gap-2">
                                        ...
                                        {hasMoreActions && <div className="relative" data-appointment-menu={appointment.id}>
                                            ...
                                            {openActionMenuId === appointment.id && <div onClick={() => setOpenActionMenuId(null)} className="absolute right-0 top-11 z-30 w-56 overflow-hidden rounded-xl border border-[#ded3cb] bg-white p-1.5 shadow-[0_14px_38px_rgba(53,29,18,.18)]">
                                                ...
                                                {canReschedule(appointment) && <button className="flex w-full items-center rounded-lg px-3 py-2.5 text-left text-sm text-[#5f351f] hover:bg-[#f8efe7] disabled:opacity-50" disabled={actionLoading === appointment.id} onClick={() => { setRescheduleAppointment(appointment); setRescheduleReason(""); setError(null); }}><CalendarDays className="mr-2 h-4 w-4"/>Reschedule appointment</button>}
